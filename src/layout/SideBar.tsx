...
function SideBar({openNav}: TSideBarProps) {
  ...
  return (
    <div className={`absolute z-10 top-24 md:top-0 md:relative scale-y-90 md:scale-y-100 opacity-0 md:opacity-100 ${openNav && " scale-y-100 opacity-100"} origin-top bg-white  rounded-2xl shadow-lg md:shadow-sm  group py-4 ${isFold ? "w-[72px] px-3" : "w-60 px-5"} transition-all duration-300 ease-in-out`}>
